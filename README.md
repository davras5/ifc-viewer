...
-   **Viewer Engine**: [web-ifc-viewer](https://github.com/IFCjs/web-ifc-viewer "null") (based on Three.js)

-   **IFC Parsing**: [web-ifc](https://www.google.com/search?q=https://github.com/thatopen/engine_web-ifc "null") (WASM)

-   **Excel Generation**: [SheetJS (xlsx)](https://sheetjs.com/ "null")
